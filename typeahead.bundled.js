 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $=globalThis,x=t=>t,S=$.trustedTypes,_=S?S.createPolicy("lit-html",{createHTML:t=>t}):void 0,k="$lit$",C=`lit$${Math.random().toFixed(9).slice(2)}$`,A="?"+C,E=`<${A}>`,M=document,O=()=>M.createComment(""),T=t=>null===t||"object"!=typeof t&&"function"!=typeof t,z=Array.isArray,U="[ \t\n\f\r]",j=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,I=/-->/g,N=/>/g,P=RegExp(`>|${U}(?:([^\\s"'>=/]+)(${U}*=${U}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),D=/'/g,R=/"/g,L=/^(?:script|style|textarea|title)$/i,B=(t=>(i,...s)=>({_$litType$:t,strings:i,values:s}))(1),F=Symbol.for("lit-noChange"),H=Symbol.for("lit-nothing"),V=new WeakMap,W=M.createTreeWalker(M,129);function Z(t,i){if(!z(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==_?_.createHTML(i):i}const J=(t,i)=>{const s=t.length-1,e=[];let o,h=2===i?"<svg>":3===i?"<math>":"",n=j;for(let i=0;i<s;i++){const s=t[i];let r,a,l=-1,c=0;for(;c<s.length&&(n.lastIndex=c,a=n.exec(s),null!==a);)c=n.lastIndex,n===j?"!--"===a[1]?n=I:void 0!==a[1]?n=N:void 0!==a[2]?(L.test(a[2])&&(o=RegExp("</"+a[2],"g")),n=P):void 0!==a[3]&&(n=P):n===P?">"===a[0]?(n=o??j,l=-1):void 0===a[1]?l=-2:(l=n.lastIndex-a[2].length,r=a[1],n=void 0===a[3]?P:'"'===a[3]?R:D):n===R||n===D?n=P:n===I||n===N?n=j:(n=P,o=void 0);const d=n===P&&t[i+1].startsWith("/>")?" ":"";h+=n===j?s+E:l>=0?(e.push(r),s.slice(0,l)+k+s.slice(l)+C+d):s+C+(-2===l?i:d)}return[Z(t,h+(t[s]||"<?>")+(2===i?"</svg>":3===i?"</math>":"")),e]};class K{constructor({strings:t,_$litType$:i},s){let e;this.parts=[];let o=0,h=0;const n=t.length-1,r=this.parts,[a,l]=J(t,i);if(this.el=K.createElement(a,s),W.currentNode=this.el.content,2===i||3===i){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(e=W.nextNode())&&r.length<n;){if(1===e.nodeType){if(e.hasAttributes())for(const t of e.getAttributeNames())if(t.endsWith(k)){const i=l[h++],s=e.getAttribute(t).split(C),n=/([.?@])?(.*)/.exec(i);r.push({type:1,index:o,name:n[2],strings:s,ctor:"."===n[1]?X:"?"===n[1]?tt:"@"===n[1]?it:Q}),e.removeAttribute(t)}else t.startsWith(C)&&(r.push({type:6,index:o}),e.removeAttribute(t));if(L.test(e.tagName)){const t=e.textContent.split(C),i=t.length-1;if(i>0){e.textContent=S?S.emptyScript:"";for(let s=0;s<i;s++)e.append(t[s],O()),W.nextNode(),r.push({type:2,index:++o});e.append(t[i],O())}}}else if(8===e.nodeType)if(e.data===A)r.push({type:2,index:o});else{let t=-1;for(;-1!==(t=e.data.indexOf(C,t+1));)r.push({type:7,index:o}),t+=C.length-1}o++}}static createElement(t,i){const s=M.createElement("template");return s.innerHTML=t,s}}function q(t,i,s=t,e){if(i===F)return i;let o=void 0!==e?s._$Co?.[e]:s._$Cl;const h=T(i)?void 0:i._$litDirective$;return o?.constructor!==h&&(o?._$AO?.(!1),void 0===h?o=void 0:(o=new h(t),o._$AT(t,s,e)),void 0!==e?(s._$Co??=[])[e]=o:s._$Cl=o),void 0!==o&&(i=q(t,o._$AS(t,i.values),o,e)),i}class G{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:s}=this._$AD,e=(t?.creationScope??M).importNode(i,!0);W.currentNode=e;let o=W.nextNode(),h=0,n=0,r=s[0];for(;void 0!==r;){if(h===r.index){let i;2===r.type?i=new Y(o,o.nextSibling,this,t):1===r.type?i=new r.ctor(o,r.name,r.strings,this,t):6===r.type&&(i=new st(o,this,t)),this._$AV.push(i),r=s[++n]}h!==r?.index&&(o=W.nextNode(),h++)}return W.currentNode=M,e}p(t){let i=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++}}class Y{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,i,s,e){this.type=2,this._$AH=H,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cv=e?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===t?.nodeType&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=q(this,t,i),T(t)?t===H||null==t||""===t?(this._$AH!==H&&this._$AR(),this._$AH=H):t!==this._$AH&&t!==F&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>z(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==H&&T(this._$AH)?this._$AA.nextSibling.data=t:this.T(M.createTextNode(t)),this._$AH=t}$(t){const{values:i,_$litType$:s}=t,e="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=K.createElement(Z(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===e)this._$AH.p(i);else{const t=new G(e,this),s=t.u(this.options);t.p(i),this.T(s),this._$AH=t}}_$AC(t){let i=V.get(t.strings);return void 0===i&&V.set(t.strings,i=new K(t)),i}k(t){z(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new Y(this.O(O()),this.O(O()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e)}_$AR(t=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);t!==this._$AB;){const i=x(t).nextSibling;x(t).remove(),t=i}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class Q{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,s,e,o){this.type=1,this._$AH=H,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=H}_$AI(t,i=this,s,e){const o=this.strings;let h=!1;if(void 0===o)t=q(this,t,i,0),h=!T(t)||t!==this._$AH&&t!==F,h&&(this._$AH=t);else{const e=t;let n,r;for(t=o[0],n=0;n<o.length-1;n++)r=q(this,e[s+n],i,n),r===F&&(r=this._$AH[n]),h||=!T(r)||r!==this._$AH[n],r===H?t=H:t!==H&&(t+=(r??"")+o[n+1]),this._$AH[n]=r}h&&!e&&this.j(t)}j(t){t===H?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class X extends Q{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===H?void 0:t}}class tt extends Q{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==H)}}class it extends Q{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5}_$AI(t,i=this){if((t=q(this,t,i,0)??H)===F)return;const s=this._$AH,e=t===H&&s!==H||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==H&&(s===H||e);e&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class st{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){q(this,t)}}const et=$.litHtmlPolyfillSupport;et?.(K,Y),($.litHtmlVersions??=[]).push("3.3.3");const ot=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */var dt=function(t,i,s,e){for(var o,h=arguments.length,n=h<3?i:null===e?e=Object.getOwnPropertyDescriptor(i,s):e,r=t.length-1;r>=0;r--)(o=t[r])&&(n=(h<3?o(n):h>3?o(i,s,n):o(i,s))||n);return h>3&&n&&Object.defineProperty(i,s,n),n};let ut=0,pt=class extends ht{constructor(){super(...arguments),this.name="",this.items=[],this.emitObject=!1,this.placeholder="",this.selectFirst=!1,this.value="",this.useNative=!1,this._isOpen=!1,this._filteredItems=[],this._activeIndex=-1,this._searchText="",this._listId="lit-typeahead-list-"+ut++,this._listboxId="lit-typeahead-listbox-"+ut++}willUpdate(t){(t.has("items")||t.has("selectFirst"))&&this.selectFirst&&!this.value&&this.items.length>0&&(this.value=this._itemValue(this.items[0])),(t.has("items")||t.has("selectFirst"))&&(this._filteredItems=this._filterItems(this._searchText),this._activeIndex>=this._filteredItems.length&&(this._activeIndex=-1),0===this._filteredItems.length&&(this._isOpen=!1)),t.has("useNative")&&this._closeDropdown()}render(){return this.useNative?this._renderNative():this._renderCustom()}_renderNative(){const t=this.id||void 0;return B`
      ...
      <datalist id=${this._listId}>
        ${this.items.map(t=>B`<option value=${this._itemValue(t)}
    ...
    `}_renderCustom(){const t=this.id||void 0,i=this._isOpen?"typeahead is-open":"typeahead";return B`
      <div class=${i}>
        ...
        ${this._isOpen&&this._filteredItems.length>0?B`
              ...
              >
                ${this._filteredItems.map((t,i)=>{const s=[i===this._activeIndex?"active":"",this._itemValue(t)===this.value?"is-selected":""].filter(Boolean).join(" ");return B`
                    <li
    ...
    `}_handleNativeChange(t){const i=t.target;this.value=i.value;const s=this._findMatchingItem(this.value);this._dispatchChange(s??this.value),void 0!==s&&this._dispatchItemSelected(this._itemValue(s))}_handleInput(t){const i=t.target;this._searchText=i.value,this._filteredItems=this._filterItems(i.value),this._activeIndex=-1,this._isOpen=this._filteredItems.length>0}_handleFocus(){this._openDropdown()}_handleInputClick(){this._isOpen||this._openDropdown()}_handleBlur(){this._closeDropdown()}_handleListMouseDown(t){t.preventDefault()}_handleIconMouseDown(t){t.preventDefault()}_handleIconClick(t){t.preventDefault(),this._isOpen?this._closeDropdown():this._openDropdown()}_handleKeydown(t){if("ArrowDown"===t.key&&!this._isOpen)return t.preventDefault(),this._openDropdown(),void(this._isOpen&&(this._activeIndex=0));if(this._isOpen&&0!==this._filteredItems.length)switch(t.key){case"ArrowDown":t.preventDefault(),this._activeIndex=(this._activeIndex+1)%this._filteredItems.length;break;case"ArrowUp":t.preventDefault(),this._activeIndex=this._activeIndex<=0?this._filteredItems.length-1:this._activeIndex-1;break;case"Enter":t.preventDefault(),this._activeIndex>=0&&this._activeIndex<this._filteredItems.length?this._selectItem(this._filteredItems[this._activeIndex]):this._closeDropdown();break;case"Escape":t.preventDefault(),this._closeDropdown()}}_selectItem(t){this.value=this._itemValue(t),this._closeDropdown(),this._dispatchChange(t),this._dispatchItemSelected(this._itemValue(t))}_openDropdown(){if(0===this.items.length)return void(this._isOpen=!1);this._searchText="",this._filteredItems=this._filterItems(""),this._activeIndex=-1,this._isOpen=!0;const t=this.shadowRoot?.querySelector("input");t instanceof HTMLInputElement&&t.focus()}_closeDropdown(){this._isOpen=!1,this._activeIndex=-1,this._searchText=this.value}_filterItems(t){const i=t.trim().toLowerCase();return""===i?[...this.items]:this.items.filter(t=>this._itemLabel(t).toLowerCase().includes(i))}_findMatchingItem(t){const i=t.trim().toLowerCase();return this.items.find(t=>this._itemValue(t).toLowerCase()===i)}_itemLabel(t){return"string"==typeof t?t:t.label}_itemValue(t){return"string"==typeof t?t:t.value}_dispatchChange(t){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.emitObject?t:this._itemValue(t)},bubbles:!0,composed:!0}))}_dispatchItemSelected(t){this.dispatchEvent(new CustomEvent("item-selected",{detail:{value:t},bubbles:!0,composed:!0}))}};pt.styles=((t,...i)=>{const e=1===t.length?t[0]:i.reduce((i,s,e)=>i+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[e+1],t[0]);return new o(e,t,s)})`
    :host {
      display: block;
      position: relative;
    }
